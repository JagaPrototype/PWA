...
const Counter3 = (props: counter3Props) => {
    const {
        label = "7",
        size,
        variant,
            ...
            <div id="2_23057" className="symbol-2_23057">
                {size === "xs (16)" && variant === "primary" && (
                    ...
                    >
                        <p
                            id="2_23059"
                            className="paragraph-2_23059 fill-lightaccenton-accent-2_4580-paragraph text-caption-m-strong-2_2229 fill-lightbgsurface1-2_2272-paragraph"
                        >
                ...
                {size === "xs (16)" && variant === "contrast" && (
                    <div
                        id="2_23064"
                        className="symbol-2_23064 fill-lightbgsurface1-2_22049 fill-lightbgsurface1-2_2272"
                    >
                        <p
                            id="2_23065"
                ...
                {size === "m (24)" && variant === "primary" && (
                    ...
                    >
                        <p
                            id="2_23069"
                            className="paragraph-2_23069 fill-lightaccenton-accent-2_4580-paragraph text-caption-l-strong-2_20366 fill-lightbgsurface1-2_2272-paragraph"
                        >
                            {label ??
                                text_4_29496_2_23069 ??
                                text_2_23069 ??
